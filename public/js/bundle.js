...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2llbnlpZXAiLCJhIjoiY2wxM251bmpmMDB6OTNsbnYxeG9qNjBmOCJ9.qgT1sQb8ByZkbWBqmA2aqg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/kienyiep/cl0oqkyea005s14jzuf0l6zzp',
    // style URL
    scrollZoom: false // center: [-118.113491, 34.111745], // starting position [lng, lat]
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // add a new marker inside the mapbox
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ":  ").concat(loc.description, "</p>")).addTo(map); //extend the map bound to include the current location
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              // since the api and website will be hosted in the same server, this will work perfectly fine
              data: {
                email: email,
                password: password
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); //  automatically be directed back to a page
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // console.log(err.response.data);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"register.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteTour.js":[function(require,module,exports) {
"use strict";
...
var deleteTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(deleteId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/tours/".concat(deleteId)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'delete tour successful!'); //  automatically be directed back to a page
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"forgotPassword.js":[function(require,module,exports) {
"use strict";
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(password, passwordConfirm, resetToken) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addNewTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addTour = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KdWUNI2gFXpKucHEY5FFVwmWNF4OhnxmPvUzRrMTGrCCkgUP0EfHNpxiFIij2Z9zNfnbvRgfVWiCGsBqMQUx1AI00p2zeNs1L');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            console.log(session); // 2) Create checkout form + charged credit card
...
var addTourForm = document.querySelector('.form--addTour');
var updateTourForm = document.querySelector('.form--updateTour');
var logOutBtn = document.querySelector('.nav__el--logout');
var userPasswordForm = document.querySelector('.form-user-password');
var forgotBtn = document.getElementById('forgotBtn');
var addTourBtn = document.getElementById('add_tour');
var forgotPassword = document.getElementById('forgotBtn');
var userDataForm = document.querySelector('.form-user-data');
var bookBtn = document.getElementById('book-tour');
var deleteBtn = document.getElementById('btn--delete'); // const btnDeleteBox = document.getElementById('btnDelete');
//DELEGATION
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _register.register)(name, email, password, passwordConfirm);
  });
}
...
if (resetForm) {
  resetForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    var tokenId = tokenBox.dataset.token;
    (0, _resetPassword.resetPassword)(password, passwordConfirm, tokenId);
  });
}
...
if (forgotForm) {
  forgotForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    (0, _forgotPassword.forgot)(email);
  });
}
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // programatically recreate multi part form data
              ...
              _context.next = 7;
              return (0, _updateSettings.updateSettings)(newform, 'data');
...
if (deleteBtn) {
  deleteBtn.addEventListener('click', function (ev) {
    ...
    var deleteId = ev.target.dataset.deleteId;
    (0, _deleteTour.deleteTour)(deleteId);
  });
}
